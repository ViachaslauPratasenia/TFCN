...
public class SerialPortController implements SerialPortInterface{
    ...
    public boolean sendXon() throws SerialPortException{
        return this.serialPort.writeByte(SerialPortController.XON_CHAR);
    }

    @Override
    public boolean sendXoff() throws SerialPortException {
        return this.serialPort.writeByte(SerialPortController.XOFF_CHAR);
    }
